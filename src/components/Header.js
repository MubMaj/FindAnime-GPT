...
function Header() {
  ...
  return (
    <div className="px-10 max-sm:px-4 bg-black/[0.5] flex justify-between items-center">
      <div>
      ...
      <div className="font-bold text-xl text-white cursor-default">{user?.displayName}</div>
      {user && <button
